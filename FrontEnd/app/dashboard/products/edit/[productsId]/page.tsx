  ...
  return (
    <div className="w-100">
        ...
        <div className="d-flex gap-4">
          ...
          <form className="d-flex flex-column gap-3 flex-grow-1" style={{ flex: 2 }}>
            ...
            <button 
              ...
              style={{ backgroundColor: '#56e0ffff', color: '#ffffffff'}}
            >
              Apply Changes
            </button>
          </form>
      ...
      <div className="bg-white rounded-3 shadow table-responsive">
        <h2 className="fs-5 fw-semibold p-4 mb-0 border-bottom text-dark" style={{ borderColor: '#f3f4f6' }}>Last Edited products</h2> 
        <table className="table table-hover mb-0">
          <thead>
            <tr>
              <th className="text-uppercase text-secondary small fw-bold bg-light" style={{ padding: '1rem 1.5rem', borderBottomWidth: '1px' }}>Product picture</th>
              <th className="text-uppercase text-secondary small fw-bold bg-light" style={{ padding: '1rem 1.5rem', borderBottomWidth: '1px' }}>Product Name</th>
              <th className="text-uppercase text-secondary small fw-bold bg-light" style={{ padding: '1rem 1.5rem', borderBottomWidth: '1px' }}>Price</th>
              <th className="text-uppercase text-secondary small fw-bold bg-light" style={{ padding: '1rem 1.5rem', borderBottomWidth: '1px' }}>Description</th>
              <th className="text-uppercase text-secondary small fw-bold bg-light" style={{ padding: '1rem 1.5rem', borderBottomWidth: '1px' }}>Quantity</th>
            </tr>
          </thead>
          <tbody>
            {lastEditedProducts.map((product, index) => (
              <tr key={index}>
                <td className="align-middle text-secondary" style={{ padding: '1rem 1.5rem', fontSize: '0.875rem', borderBottom: '1px solid #f3f4f6' }}>
                  <Image
                    src={product.img}
                    alt={product.name}
                    width={32}
                ...
                <td className="align-middle text-dark fw-medium" style={{ padding: '1rem 1.5rem', fontSize: '0.875rem', borderBottom: '1px solid #f3f4f6' }}>
                  {product.name}
                </td>
                <td className="align-middle text-dark" style={{ padding: '1rem 1.5rem', fontSize: '0.875rem', borderBottom: '1px solid #f3f4f6' }}>{product.price}</td>
                <td className="align-middle text-dark" style={{ padding: '1rem 1.5rem', fontSize: '0.875rem', borderBottom: '1px solid #f3f4f6' }}>{product.desc}</td>
                <td className="align-middle text-dark" style={{ padding: '1rem 1.5rem', fontSize: '0.875rem', borderBottom: '1px solid #f3f4f6' }}>{product.qty}</td>
              </tr>
            ))}
          </tbody>
        </table>
